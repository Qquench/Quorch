...
> **角色解耦定义**：在 Quench 治理体系中，“架构审查模型 (Reviewer)”是指用户自选用于系统架构分析与深度推理的高阶模型（如 Claude 3.7 / Opus、GPT-4.5 / o3、Gemini Pro、DeepSeek R1 等）。审查模型由用户根据自身订阅与预算自主选定并手动切换，系统不与任何特定厂商或具体模型强绑定。
