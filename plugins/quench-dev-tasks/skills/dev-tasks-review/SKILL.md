...
description: 指导 Opus 审查或架构规划者如何进行代码审查、编写架构演进任务单、评定缺陷与弹性质量分级。当用户要求审查架构、评估重构方案或由 Flash 升级为深度审查时使用。
---

# Quench 架构与任务审查指南 (Dev-Tasks Review)

本指南面向高阶架构师与深度审查者（Opus 审查 Subagent 或通用高级模型），指导如何开展高质量、贴合业务实际的工程审查与任务规划。
