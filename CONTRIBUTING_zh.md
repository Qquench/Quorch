...
> [!TIP]
> **关于跨工具与跨平台适配的说明**：  
> 本工具源于作者在 **Windows 环境下使用 Google Antigravity IDE** 进行开发时的实际需求，核心源码已完全跑通验证。而泛化至其他工具（如 **Cursor** 等）以及其他操作系统（macOS/Linux）的接口层，由于作者缺乏相关实操开发经验，完全由 AI 基于既有架构推演生成，可能存在部分边缘问题。特别期待在相关环境下深度开发的社区朋友们提交 Issue 或 PR 共同完善！
