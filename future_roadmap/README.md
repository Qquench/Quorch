...
| ⚡ **[stage3_cross_tool_cursor_adaptation.md](./stage3_cross_tool_cursor_adaptation.md)** | **阶段三：以 Cursor 为切入点的跨开发工具适配** | Cursor / Windsurf / Git CLI | **单核多适配器通用架构**（85% 核心共用 + 15% 接入外壳）、`.cursorrules` 自动导出、Git Pre-commit 物理兜底防线、Quench CLI 工具 |
