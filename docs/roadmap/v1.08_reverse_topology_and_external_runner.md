...
> **关联任务单**:
> - 📋 `docs/dev_tasks/2026-09-24_v1.08_step01_probe_and_scope_reconciliation.md` (Tasks 1.1, 1.2, 1.3 待领单)
> - 📋 `docs/dev_tasks/2026-09-24_v1.08_step02_lease_heartbeat_and_dual_process_cas.md` (Tasks 2.1, 2.2 待领单)
> - 📋 `docs/dev_tasks/2026-09-24_v1.08_step03_capability_tokens_and_onboarding.md` (Tasks 3.1, 3.2, 3.3 待领单)
> 
