# Milestone v1.08: 逆向拓扑与外部执行器接入 (Asymmetric Dual-Host & External Runner Governance)
## Reverse-Topology & External-Runner Roadmap

> **路线图状态**: 🔨 任务编制中 (Phases 0~5 规划就绪，批次任务单编制推进中)  
> **起始时间**: 2026-09-24  
> **前置里程碑**: ✔️ v1.07 交付归档 (`docs/roadmap/archive/v1.07_architecture_doc_integrity_and_neutrality_decoupling.md`)  
> **关联任务单**:
> - ✔️ `docs/dev_tasks/archive/2026-09-24_v1.08_step01_probe_and_scope_reconciliation.md` (Tasks 1.1~1.3 已归档闭环)
> - ✔️ `docs/dev_tasks/archive/2026-09-24_v1.08_step02_lease_heartbeat_and_dual_process_cas.md` (Tasks 2.1~2.4 已归档闭环)
> - 📋 `docs/dev_tasks/2026-09-24_v1.08_step03_capability_tokens_and_onboarding.md` (Tasks 3.1~3.3 待领单)
> - ✔️ `docs/dev_tasks/archive/2026-09-25_v1.08_step04_async_reviewer_jobs.md` (Tasks 4.0~4.1 已归档闭环)
> - ✔️ `docs/dev_tasks/archive/2026-09-25_v1.08_step04_corrections.md` (Tasks 4.2~4.5 已归档闭环)
> 
> **文档路径**: `docs/roadmap/v1.08_reverse_topology_and_external_runner.md`  
> **发布日期**: 2026-09-24  
...
| **Aider** | ❌ 原生无 MCP | ❌ 无 PreToolUse 钩子 | 原生支持 `--openai-api-base` | ❌ 不支持 | ⭐⭐ (需 MCP Bridge) |
...
4. **绝不破坏 12 个 MCP 核心工具的接口纯净度**：除非通过正式架构评审与全量单测，严禁为单一客户端特异化新增非标工具。
